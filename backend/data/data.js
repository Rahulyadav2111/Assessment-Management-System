module.exports = [
  {
    ...
    exercises: [
      {
        ...
        setList: [
          {
            additionalFields: [
              { fieldName: 'accuracy', fieldText: 'Score', fieldUnit: '%', fieldValue: '0.0', shouldDisplay: false },
            ],
            correctReps: 1,
            incorrectReps: 0,
            isSkipped: false,
        ...
        side: 'left',
        tipsList: ['Practice shoulder alignment exercises daily.', 'Focus on maintaining head center alignment.'],
        totalReps: 1,
        totalSets: 1,
        variationId: '',
        variationName: '',
      },
      {
        ...
        side: 'left',
        tipsList: ['Engage in neck strengthening exercises.', 'Consciously practice standing with straight knees.'],
        totalReps: 1,
        totalSets: 1,
        variationId: '',
        variationName: '',
      },
      {
        ...
        setList: [
          {
            additionalFields: [
              { fieldName: 'accuracy', fieldText: 'Score', fieldUnit: '%', fieldValue: '99.17062', shouldDisplay: false },
            ],
            correctReps: 1,
            incorrectReps: 0,
            isSkipped: false,
      ...
      },
      {
        ...
        setList: [
          {
            additionalFields: [
              { fieldName: 'accuracy', fieldText: 'Score', fieldUnit: '%', fieldValue: '93.333336', shouldDisplay: false },
              { fieldName: 'reps', fieldText: 'Reps', fieldUnit: 'reps', fieldValue: '42', shouldDisplay: true },
            ],
            correctReps: 42,
            incorrectReps: 0,
            isSkipped: false,
      ...
      },
      {
        ...
        setList: [
          {
            additionalFields: [
              { fieldName: 'accuracy', fieldText: 'Score', fieldUnit: '%', fieldValue: '75.11575', shouldDisplay: false },
              { fieldName: 'Distance', fieldText: 'Distance', fieldUnit: 'CM', fieldValue: '45.538174', shouldDisplay: false },
            ],
            correctReps: 1,
            incorrectReps: 0,
            isSkipped: false,
    ...
    vitalsMap: {
      ...
      metadata: {
        ...
        fps: 114,
        glucose_info: { diabetes_control_score: 57.5, hba1c: 5.2, status: 'beta' },
        heart_scores: {
          HRMax: 191,
          HRR: '116',
          THRR: '145 - 191',
      ...
      statusCode: 200,
      vitals: { bp_dia: 82, bp_sys: 124, heart_rate: 75, oxy_sat_prcnt: 96, resp_rate: 21 },
      wellness_score: 84,
    },
    weight: 111,
  },
  {
    ...
    exercises: [
      {
        ...
        setList: [
          {
            additionalFields: [
              { fieldName: 'accuracy', fieldText: 'Score', fieldUnit: '%', fieldValue: '0', shouldDisplay: false },
            ],
            correctReps: 1,
            incorrectReps: 0,
            isSkipped: false,
      ...
      },
      {
        ...
        setList: [
          {
            additionalFields: [
              { fieldName: 'accuracy', fieldText: 'Score', fieldUnit: '%', fieldValue: '15.164222764530614', shouldDisplay: false },
            ],
            correctReps: 0,
            incorrectReps: 0,
            isSkipped: false,
    ...
    vitalsMap: {
      ...
      metadata: {
        ...
        fps: 114,
        glucose_info: { diabetes_control_score: 77.5, hba1c: 5.2, status: 'beta' },
        heart_scores: {
          HRMax: 191,
          HRR: '125',
          THRR: '< 90',
      ...
      vitals: { bp_dia: 75, bp_sys: 110, heart_rate: 66, oxy_sat_prcnt: 95, resp_rate: 19 },
      wellness_score: 84,
    },
    weight: 20,
  },
